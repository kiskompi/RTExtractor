...
class RTClassifier:
    ...
    """
    def __init__(self, crawl_target: str):
    ...
    def scroll_down(self, browser: Browser):
        ...
        * Ha betöltődik, akkor újra vektorba rendezi a inkeket, de csak azokat a SectionReveaLButton
        ...
        while True or i and 10:
            driver.execute_script("window.scrollTo(0, document.body.scrollHeight);")
            current = len(driver.execute_script("return document.documentElement.outerHTML;"))
            if current == prior:
                return current
            prior = current
    ...
    @classmethod
    def html2json(cls, code: str) -> str:
        """
    ...
    def process_html(self, browser: Browser, document: str):
        """
    ...
    def run(self):
        ...
        browser.visit(self.inner_links[0].url)
        self.process_html(browser, browser.html)
