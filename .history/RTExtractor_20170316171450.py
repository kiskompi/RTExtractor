...
class Element:
    ...
    def __init__(self, url="", tag="", code="", crawler_class=""):
        self.url = url
        self.tag = tag
        self.code = code
    ...
    def json2element(self, json_element):
        ...
        self = Element(**json_element)

    def print(self):
        """
        print
        """
        print("URL"+self.url+"tag"+self.tag+"code"+self.code+"class"+self.crawler_class)

def import_learning_set(file):
    """
