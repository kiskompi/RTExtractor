...
class HTMLAttribute:
    ...
    * values[]: a tag-hez tartozó értékek (a kódban whitespace-szel elválasztva)
    ...
    def extract_values(code: str) -> str[]:
        ...
        This function gets an HTML code fragment like this:
        nonStandardAttr="value1 value2 value3"
        And returns the vector of the values of the attribute (in this case ***[value1, value2, value3]***)
        """
        pass
...
class Element:
    ...
    A structure consisting of the HTML tag, HTML tags and their values and the crawlerclass.
        ...
        data:: the class of the element determined either by the gold standard or the decision tree
    """
