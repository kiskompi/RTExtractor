...
class RTClassifier:
    ...
    def scroll_down(self, browser: Browser):
        ...
        an upper treshold. When new data is loaded it reruns the classification on the newly 
    ...
    def html2element(self, code: str) -> str:
        """
        This function creates a json entry from the code of an  HTML element.
        Parameters
        ----------
        code : str
            The HTML code fragment fro which the function generates the json element.

        Returns
        -------
        str
            The json element generated by the function.
        """
    ...
    def process_html(self, browser: Browser):
        ...
        listázza az elemeket, classzifikálja (vagy elhagyja) őket, és berakja a 
        megfelelő array-be
        """
