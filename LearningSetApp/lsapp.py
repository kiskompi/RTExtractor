...
Needs: 
Element class to represent DOM elements (model)
GUI class to represent the data (view)
Some handler which read and writes the data file and uses Element (controller)
"""
...
class Element():
    ...
    def __init__(self, _HTMLtag, _HTMLClasses, _CrawlerClass):
        self.html_tag = _HTMLtag
        self.html_classes = _HTMLClasses
        self.crawler_class = _CrawlerClass
